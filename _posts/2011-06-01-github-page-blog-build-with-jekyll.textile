...
在godaddy中注册 "fqntx.me":http://fqntx.me 域名，.me专用于博客类型，但比.com贵一些，且没有优惠

# 注册完域名后，在域名管理中增加A record并指向207.97.227.245
# 在你的github项目下增加CNAME文件，内容为你的域名，如 "http://github.com/fqntxmqee/fqntxmqee.github.com/blob/master/CNAME":http://github.com/fqntxmqee/fqntxmqee.github.com/blob/master/CNAME
...
注册成功后，为简单起见，只要把 @_includes/post.html@ 中的fqntxmqee替换为你的注册帐号就行了(disqus_url输入你实际的域名)
...
最快的做法是 "fork我的博客":http://github.com/fqntxmqee/fqntxmqee.github.com ，git clone到你的电脑
然后修改成你的，具体需要调整的地方是:
